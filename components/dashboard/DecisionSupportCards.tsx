    ...
    <div className="space-y-5">
      ...
      <Card className="premium-ring">
        ...
        <CardContent className="space-y-5">
          {/* Stat row — single bordered container with dividers, no nested boxes */}
          <div className="grid grid-cols-3 divide-x divide-border overflow-hidden rounded-2xl border border-border">
            <div className="px-5 py-4">
              ...
              <p className="mt-2 text-3xl font-semibold" data-number="true">
                {activeSignals}
              </p>
              <p className="mt-1 text-xs text-muted-foreground">Live desk ideas</p>
            </div>
            <div className="px-5 py-4">
              <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">
                Best Setup
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {focusItems.map((item) => (
              <div key={item} className="flex items-start gap-3 rounded-xl border border-border px-4 py-3">
